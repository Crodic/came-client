...
export function SidebarWithSearch() {
    ...
    return (
        <Card className="min-h-screen h-full w-full p-4 shadow-xl shadow-blue-gray-900/5">
            ...
            <List>
                ...
                {auth && (
                    <ListItem className="text-red-500" onClick={handleLogout}>
                        <ListItemPrefix>
